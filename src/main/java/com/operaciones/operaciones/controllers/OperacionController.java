package com.operaciones.operaciones.controllers;

import com.operaciones.operaciones.clientes.ResultadoClienteRest;
...
public class OperacionController {
    ...
    public String restar(@RequestParam float a, @RequestParam float b) {
        return clienteFeing.mostrarResultados(a - b);
    }
}
